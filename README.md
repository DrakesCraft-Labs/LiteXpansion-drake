...
**LiteXpansion-drake** es una expansión modular del ecosistema **DrakesCraft Labs** para servidores Minecraft **Paper / Purpur 1.21.11**.
...
- **License**: GPL-3.0 / MIT.
- **Source Code**: [GitHub Repository](https://github.com/DrakesCraft-Labs/LiteXpansion-drake)
- **Support & Issues**: [GitHub Issues](https://github.com/DrakesCraft-Labs/LiteXpansion-drake/issues) | [Discord](https://discord.gg/rR7FbfCt9Y)
